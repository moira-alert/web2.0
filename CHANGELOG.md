...
* increased notification history ttl (#637)
* Chore/dark theme screenshot tests (#633)
* crud trigger info (#634)
* fix managing subs checkbox (#632)
* alphabetical subs sorting (#631)
* fix trigger cache invalidation (#628)
* fixed markdown in dark theme (#627)
* notifier page enhanced (#626)
* multiple contacts stat (#623)
* tag dropdown fixed (#624)
* added contact events paging (#622)
* Fix/hihghlight prom editor color (#621)
* configurable mainpage trigger view (#620)
* truncated metrics tooltip (#618)
* build(deps): bump axios from 1.8.4 to 1.12.1 (#619)
* Chore/use autogenerated types (#616)
