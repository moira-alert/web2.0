...
export interface IMoiraApi {
  ...
  getTriggerList(page: number, onlyProblems: boolean, tags: Array<string>, searchText: string): Promise<TriggerList>;
  getTrigger(id: string, params: Object): Promise<Trigger>;
  addTrigger(data: $Shape<Trigger>): Promise<{
    [key: string]: string;
  }>;
  setTrigger(id: string, data: $Shape<Trigger>): Promise<{
    [key: string]: string;
  }>;
  delTrigger(id: string): Promise<void>;
  setMaintenance(triggerId: string, data: {trigger?: number;metrics?: {
...
export default class MoiraApi implements IMoiraApi {
  ...
  async getTriggerList(page: number, onlyProblems: boolean, tags: Array<string>, searchText: string): Promise<TriggerList> {
  ...
  async getTrigger(id: string, params: Object): Promise<Trigger> {
    const url = `${this.apiUrl}/trigger/${encodeURI(id)}${params ? `?${queryString.stringify(params)}` : ""}`;
  ...
  async addTrigger(data: $Shape<Trigger>): Promise<{
    [key: string]: string;
  }> {
  ...
  async setTrigger(id: string, data: $Shape<Trigger>): Promise<{
    [key: string]: string;
  }> {
  ...
  async setMaintenance(triggerId: string, data: {trigger?: number;metrics?: {
      [metric: string]: number;
    };}) {
